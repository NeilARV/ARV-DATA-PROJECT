import { normalizeCountyName, trimCompanyName } from 'server/utils/normalization';
...
export function cleanTransactions(
    ...
    console.log(
        `[${cityCode} SYNC] Companies from transactions (${companyArr.length}), with county data for ${Object.keys(companyCounties).length} companies`,
    );
