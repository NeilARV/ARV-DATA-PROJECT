...
const SCAN_WINDOW = "20-46d" as const;
const DAYS_BACK_MIN = 20;
const DAYS_BACK_MAX = 46;

/**
 * Scanner B — runs Mon/Wed/Fri, covers 20-46 days ago.
 *
 * Overlaps with Scanner A on the 20-22 day range to catch any records that
