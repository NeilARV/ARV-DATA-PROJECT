...
function zipToStaticMsaName(zip: string): string | null {
    ...
    if (z >= 92201 && z <= 92599) return 'Riverside-San Bernardino-Ontario, CA';
    if (
        (z >= 94002 && z <= 94135) ||
        (z >= 94301 && z <= 94309) ||
        (z >= 94401 && z <= 94448) ||
    ...
    // Florida
    if (z >= 33001 && z <= 33499) return 'Miami-Fort Lauderdale-West Palm Beach, FL';
    if (z >= 34945 && z <= 34997) return 'Port St. Lucie, FL';
    if (
