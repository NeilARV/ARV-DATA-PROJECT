...
export async function listSenderSignatures(count = 50, offset = 0): Promise<ListSendersResponse> {
...
export function findSignatureByEmail(
    ...
    return signatures.find((s) => s.EmailAddress.trim().toLowerCase() === normalized);
}
