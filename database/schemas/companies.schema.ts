import { pgTable, uuid, varchar, text, timestamp, integer, boolean, primaryKey, serial, index, uniqueIndex, date, pgEnum, jsonb } from "drizzle-orm/pg-core";
...
export const companyAddresses = pgTable("company_addresses", {
    ...
    index("idx_company_addresses_company_id").on(t.companyId),
]);
