...
export const vendors = pgTable(
    ...
    (t) => [index('idx_vendors_user_id').on(t.userId)],
);
...
export const posts = pgTable(
    ...
    (t) => [index('idx_posts_user_id').on(t.userId), index('idx_posts_created_at').on(t.createdAt)],
);
...
export const postImages = pgTable(
    ...
    (t) => [index('idx_post_images_post_id').on(t.postId)],
);
