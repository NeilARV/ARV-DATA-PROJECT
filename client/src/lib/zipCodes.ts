export const SAN_DIEGO_ZIP_CODES = [
  ...
  { zip: '92102', city: 'San Diego' },
  { zip: '92103', city: 'San Diego' },
  { zip: '92104', city: 'San Diego' },
  { zip: '92105', city: 'San Diego' },
  { zip: '92106', city: 'San Diego' },
  { zip: '92107', city: 'San Diego' },
  { zip: '92108', city: 'San Diego' },
  { zip: '92109', city: 'San Diego' },
  { zip: '92110', city: 'San Diego' },
  { zip: '92111', city: 'San Diego' },
  { zip: '92113', city: 'San Diego' },
  { zip: '92114', city: 'San Diego' },
  { zip: '92115', city: 'San Diego' },
  { zip: '92116', city: 'San Diego' },
  { zip: '92117', city: 'San Diego' },
  { zip: '92118', city: 'Coronado' },
  { zip: '92119', city: 'San Diego' },
  { zip: '92120', city: 'San Diego' },
  { zip: '92121', city: 'San Diego' },
  { zip: '92122', city: 'San Diego' },
  { zip: '92123', city: 'San Diego' },
  { zip: '92124', city: 'San Diego' },
  { zip: '92126', city: 'San Diego' },
  { zip: '92127', city: 'San Diego' },
  { zip: '92128', city: 'San Diego' },
  { zip: '92129', city: 'San Diego' },
  { zip: '92130', city: 'San Diego' },
  { zip: '92131', city: 'San Diego' },
...
export function getCityForZipCode(zipCode: string): string | null {
  const match = SAN_DIEGO_ZIP_CODES.find(z => z.zip === zipCode);
