...
type SignupFormProps = {
    ...
    /** Called when signup is blocked by beta access (403). The modal swaps to the Contact form; pages fall back to a toast. */
    onRequestAccess?: (prefill: RequestAccessPrefill) => void;
};

export function SignupForm({ onSuccess, onSwitchToLogin, onRequestAccess }: SignupFormProps) {
    ...
    const signupMutation = useMutation({
        ...
        onError: (error: any) => {
            ...
            if (statusCode === 403) {
                const prefill: RequestAccessPrefill = {
                ...
                toast({
                    ...
                    action: onRequestAccess ? (
                        <ToastAction altText="Contact us" onClick={() => onRequestAccess(prefill)}>
                            Contact Us
                        </ToastAction>
                    ) : undefined,
                });
                    ...
                    <div className="space-y-2">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground mt-1">
                                Which area would you like to see property data for?
                            </p>
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                            <FormField
