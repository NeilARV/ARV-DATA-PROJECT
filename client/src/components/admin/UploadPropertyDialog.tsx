...
export function UploadPropertyDialog({ onClose, onSuccess }: UploadContentProps) {
  ...
  const handleSubmit = async (data: ManualPropertyEntry) => {
    ...
    try {
      ...
      toast({ title: "Property Added", description: "Property has been successfully added to the database." });
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="col-span-2">
                  ...
                  <FormControl>
                    <Input {...field} placeholder="123 Main St" required data-testid="input-address" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} placeholder="San Diego" required data-testid="input-city" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} placeholder="CA" maxLength={2} required data-testid="input-state" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} placeholder="92126" maxLength={5} required data-testid="input-manual-zipcode" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <div className="flex gap-2 pt-4">
            <Button type="button" variant="outline" onClick={onClose} className="flex-1" disabled={isSubmitting} data-testid="button-cancel-manual">
              Cancel
            </Button>
            <Button type="submit" className="flex-1" disabled={isSubmitting} data-testid="button-submit-manual">
              {isSubmitting ? (
                <>
